...
template <typename T>
	...
	std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>flattened_align(
	...
	std::tuple<torch::Tensor, torch::Tensor, torch::Tensor>flattened_align_backward(
		const torch::Tensor& xyzs,
		const torch::Tensor& xyz_ids,
		const torch::Tensor& scales,
		const torch::Tensor& rotations,
	...
	std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor>elongated_align(
		const torch::Tensor& xyzs,
		const torch::Tensor& xyz_ids,
		const torch::Tensor& rotations,
		const torch::Tensor& knn_index,
	...
	std::tuple<torch::Tensor, torch::Tensor>elongated_align_backward(
		const torch::Tensor& xyzs,
		const torch::Tensor& xyz_ids,
		const torch::Tensor& rotations,
		const torch::Tensor& binning_buffer,
